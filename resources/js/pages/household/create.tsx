...
import { index, store } from '@/routes/household';
...
export default function Create() {
    ...
    function removeMember(idx: number) {
        form.setData(
            'members',
            form.data.members.filter((_, i) => i !== idx),
        );
    }
        ...
        <>
            ...
            <div className="flex max-w-3xl flex-1 flex-col gap-6 p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* ── Submit ──────────────────────────────────────── */}
                    <div className="flex items-center justify-between gap-4 rounded-xl border border-sidebar-border/40 bg-muted/30 px-5 py-4">
                        <p className="text-sm text-muted-foreground">
                            {form.data.members.length === 0
